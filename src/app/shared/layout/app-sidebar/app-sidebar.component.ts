...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd"
          d="M4 10.5C4 7.46243 6.46243 5 9.5 5H14.5C17.5376 5 20 7.46243 20 10.5V19.25C20 19.6642 19.6642 20 19.25 20H4.75C4.33579 20 4 19.6642 4 19.25V10.5ZM9.5 6.5C7.29086 6.5 5.5 8.29086 5.5 10.5V18.5H18.5V10.5C18.5 8.29086 16.7091 6.5 14.5 6.5H9.5ZM8 11.25C8 10.8358 8.33579 10.5 8.75 10.5H10.25C10.6642 10.5 11 10.8358 11 11.25V12.75C11 13.1642 10.6642 13.5 10.25 13.5H8.75C8.33579 13.5 8 13.1642 8 12.75V11.25ZM13 11.25C13 10.8358 13.3358 10.5 13.75 10.5H15.25C15.6642 10.5 16 10.8358 16 11.25V12.75C16 13.1642 15.6642 13.5 15.25 13.5H13.75C13.3358 13.5 13 13.1642 13 12.75V11.25Z"
          fill="currentColor"/>
      </svg>`,
      name: "Hotels",
      path: "/hotels",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd"
          d="M12 2C8.13401 2 5 5.13401 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.86599-3.134-7-7-7Zm0 9.5c-1.3807 0-2.5-1.1193-2.5-2.5S10.6193 6.5 12 6.5s2.5 1.1193 2.5 2.5S13.3807 11.5 12 11.5Z"
          fill="currentColor"/>
      </svg>`,
      name: "Destinations",
      path: "/destinations",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd"
          d="M4 6.5C4 5.11929 5.11929 4 6.5 4H17.5C18.8807 4 20 5.11929 20 6.5V17.5C20 18.8807 18.8807 20 17.5 20H6.5C5.11929 20 4 18.8807 4 17.5V6.5ZM6.5 5.5C5.94772 5.5 5.5 5.94772 5.5 6.5V17.5C5.5 18.0523 5.94772 18.5 6.5 18.5H17.5C18.0523 18.5 18.5 18.0523 18.5 17.5V6.5C18.5 5.94772 18.0523 5.5 17.5 5.5H6.5Z"
          fill="currentColor"/>
      </svg>`,
      name: "Packs",
      path: "/packs",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd"
          d="M6 2.75C6 2.33579 6.33579 2 6.75 2H17.25C17.6642 2 18 2.33579 18 2.75V5H19C20.1046 5 21 5.89543 21 7V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V7C3 5.89543 3.89543 5 5 5H6V2.75ZM7.5 5H16.5V3.5H7.5V5ZM5 6.5C4.72386 6.5 4.5 6.72386 4.5 7V19C4.5 19.2761 4.72386 19.5 5 19.5H19C19.2761 19.5 19.5 19.2761 19.5 19V7C19.5 6.72386 19.2761 6.5 19 6.5H5ZM7 9.25C7 8.83579 7.33579 8.5 7.75 8.5H16.25C16.6642 8.5 17 8.83579 17 9.25C17 9.66421 16.6642 10 16.25 10H7.75C7.33579 10 7 9.66421 7 9.25ZM7.75 12.5C7.33579 12.5 7 12.8358 7 13.25C7 13.6642 7.33579 14 7.75 14H13.25C13.6642 14 14 13.6642 14 13.25C14 12.8358 13.6642 12.5 13.25 12.5H7.75Z"
          fill="currentColor"/>
      </svg>`,
      name: 'Reservations',
      path: '/reservations',
